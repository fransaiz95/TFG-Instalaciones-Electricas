...
\title{Weblectric}
\author{\nombre}
\tutor{Dr. Álvar Arnaiz González \\ Dr. Jesús Manuel Maudes Raedo}
\date{\today}
...
\noindent D. Álvar Arnaiz González y D. Jesús Manuel Maudes Raedo, profesores del departamento de Ingeniería Civil del área de Lenguajes y Sistemas Informáticos.
...
\begin{abstract}
En la actualidad, hay presente un investigador que tiene en su posesión un algoritmo de optimización para planteamientos de instalaciones eléctricas. Dicho algoritmo se nutre de datos con el objetivo de obtener una serie de resultados que posteriormente puedan ser analizarlos.
...
\begin{abstract}
At present, an investigator has an optimization algorithm to electrical installation approaches. This algorithm is nourished by data in aim of obtaining results and then analyze them.
